...
public class MsDemandMapper extends MsDocumentMapper<MsDemand>
{
    @Override
    public void bindToJson(MsDemand entity, Json jObj)
    {
    ...
    @Override
    public void bindToEntity(Json jObj, MsDemand entity)
    {
    ...
    @Override
    public MsDemand createNewEntity()
    {
        return new MsDemand();
    }

    @Override
    public Class<MsDemand> getEntityClass()
    {
        return MsDemand.class;
    }
